# Backend-CRUD-dotnet-7
Boilerplate Backend CRUD Web App created with .NET 7 by [StackPuz](https://stackpuz.com).
...
## Installation
1. Clone this repository. `git clone https://github.com/stackpuz/Backend-CRUD-dotnet-7.git .`
